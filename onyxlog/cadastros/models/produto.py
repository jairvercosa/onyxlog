...
class Produto(models.Model):
	...
	desc	 = models.CharField(verbose_name='Descrição', max_length=60, blank=False, null=False)
	desclong = models.TextField(verbose_name='Descrição Grande',blank=True,null=True)
